...
for (i in 1:100) {
  ...
  if(((i > 80) & (i < 100)) & (i != minha_idade)){
    print(paste("O número", i, "é muito grande,"))
  }
...
**Obs:** como não consta no enunciado o que deve ser impresso no console referente ao intervalo entre 80 a 99 resolvi usar a expressão 'é muito grande'. 
